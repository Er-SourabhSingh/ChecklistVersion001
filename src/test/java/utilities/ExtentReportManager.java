...
public class ExtentReportManager implements ITestListener {
    ...
    public void onStart(ITestContext testContext) {
		...
		*/
        ...
        sparkReporter.config().setDocumentTitle("Checklist Automation Report"); // Title of report
        sparkReporter.config().setReportName("Checklist Functional Testing"); // name of the report
        ...
        extent.setSystemInfo("Sub Module", "Checklist");
